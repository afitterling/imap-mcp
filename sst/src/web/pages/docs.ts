...
export const docsPage = (nonce: string, signedIn?: { name: string; email: string; role: "admin" | "user" }) =>
  page({
    title: "Manual",
  ...
  <div class="docs">
    ...
    <div class="prose">
      ...
      <p>Signing in is always e-mail + password + authenticator code. Forgot the password? Use <i>Forgot your password?</i> on the sign-in page. Lost the authenticator? An administrator resets it and you set up a new one at the next sign-in. The app has five tabs: <b>Accounts</b> (mailboxes), <b>Calendars</b>, <b>Outbox</b> (mail waiting for your approval), <b>Connect Claude</b> (tokens and connected apps), <b>Activity</b> (everything that happened) and <b>Security</b> (password, factors, sessions).</p>
      ...
      <ul>
        ...
        <li><b>Alerts:</b> every new sign-in, failed attempt, new token, new connector, factor change and admin action is mailed to you.</li>
        ...
        <li><b>Lost phone:</b> an administrator resets your two-factor setup; Cognito asks you to enrol a new authenticator at the next sign-in.</li>
      </ul>
    </div>
  </div>
